...
proc create_root_design { parentCell } {
  ...
  # Create instance: ltc2324_0, and set properties
  set ltc2324_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_DMA_LTC2324_16:1.0 ltc2324_0 ]
  ...
  # Create instance: rst_clk_33M_0, and set properties
  set rst_clk_33M_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_33M_0 ]
  ...
  connect_bd_intf_net -intf_net ad9280_sample_0_M00_AXIS [get_bd_intf_pins axis_register_slice_0/S_AXIS] [get_bd_intf_pins ltc2324_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ltc2324_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net rst_ps7_0_142M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins ltc2324_0/m00_axis_aresetn] [get_bd_pins rst_ps7_0_142M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ltc2324_0/S00_AXI/S00_AXI_reg] SEG_ad9280_sample_0_S00_AXI_reg
